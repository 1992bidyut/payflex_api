...
class Payment_methodes extends REST_Controller
{
	...
	function index_post(){
		...
		$response['bank_list']=$this->payment_model->getBankList();
		$response['Payment_methode']=$this->payment_model->getPaymentMode();
